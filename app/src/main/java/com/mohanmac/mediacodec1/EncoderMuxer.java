...
public class EncoderMuxer {
     ...
     */
    public void testEncodeVideoToMp4(String outputFile) {
        // QVGA at 2Mbps
        mWidth = 320;
        mHeight = 240;
        mBitRate = 1000000;
     ...
     */
    private void prepareEncoder(String outputFile) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.d(TAG,"No able ot create encoder");
        }
        ...
        Log.d(TAG, "output file is " + outputFile);
